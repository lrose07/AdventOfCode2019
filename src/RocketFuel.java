 ...
 * requires 70 more fuel, which requires 21 fuel, which requires 5 fuel, which requires no further fuel. So, the total fuel required for a module of mass 1969 is 654 + 216 + 70 + 21 + 5 = 966.
 ...
 * the mass of the added fuel? (Calculate the fuel requirements for each module separately, then
...
class RocketFuel {
    ...
    /**
     * Parses the contents of the input file and adds them to an array
     */
    ...
    /**
     * Calculates the total fuel needed
     */
    ...
    /**
     * Calculates fuel needed for individual mass
     * @param _mass mass being calculated
     * @return fuel needed for given mass
     */
